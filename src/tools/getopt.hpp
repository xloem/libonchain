...
std::unordered_map<std::string, std::vector<std::string>> getopt(std::string name, int argc, char const *argv[], std::initialize_list<option> options)
{
